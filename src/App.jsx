        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-lg border bg-white p-5 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <button className="p-4 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 hover:shadow-md transition-all text-left group">
                <div className="text-3xl mb-2 group-hover:scale-110 transition-transform">🚪</div>
                <div className="font-bold text-sm">Logout</div>
                <div className="text-xs text-gray-600 mt-1">Sign out safely</div>
              </button>
              
              <button className="p-4 rounded-lg border border-red-200 bg-red-50 hover:bg-red-100 hover:shadow-md transition-all text-left group">
                <div className="text-3xl mb-2 group-hover:scale-110 transition-transform">🗑️</div>
                <div className="font-bold text-sm text-red-700">Delete Account</div>
                <div className="text-xs text-red-600 mt-1">Remove permanently</div>
              </button>
              
              <button className="p-4 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 hover:shadow-md transition-all text-left group">
                <div className="text-3xl mb-2 group-hover:scale-110 transition-transform">📤</div>
                <div className="font-bold text-sm">Export Data</div>
                <div className="text-xs text-gray-600 mt-1">Download info</div>
              </button>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 mt-0.5">Order & offer updates</div>
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
                    ...
                    />
                    <div className="w-11 h-6 bg-gray-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-500"></div>
                  </label>
                </div>
              </div>
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 mt-0.5">Newsletters & offers</div>
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 mt-0.5">Better suggestions</div>
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
                    <input type="checkbox" defaultChecked={true} className="sr-only peer" />
